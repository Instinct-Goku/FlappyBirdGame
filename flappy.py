...
def end_screen(win,score):
    end_label0 = END_FONT.render("You Lose!",1,(215,0,0))
    end_label1 = END_FONT.render("Highest Score: " + str(score),1,(215,0,0))
    win.blit(end_label0, (100, 250))
    win.blit(end_label1, (100, 275))
